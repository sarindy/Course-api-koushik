...
public class TopicController {
	...
	@RequestMapping(value="/getTopic/{id}")
	public ResponseEntity<TopicModel> getTopic(@PathVariable Long id){
		return new ResponseEntity<TopicModel>(topicService.getTopic(id),HttpStatus.OK);
